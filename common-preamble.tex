...
\newcommand{\ana}[1]{{\textbf{\textcolor[rgb]{0.6,0.6,0.9}{Ana: #1}}}}
\newcommand{\ted}[1]{{\textbf{\textcolor[rgb]{0.6,0.6,0.9}{Ted: #1}}}}

\newcommand{\paragraphtight}[1]{\paragraph{#1}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Characters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\renewcommand{\binary}{O1}
\newcommand{\unspecified}{O2}
\newcommand{\var}{O4}
\newcommand{\dataset}{O5}
\newcommand{\userstudy}{O6}
\newcommand{\classifier}{O7}
\newcommand{\yes}{X}
