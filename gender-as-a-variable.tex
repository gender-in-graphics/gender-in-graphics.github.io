...
\ana{SMPL has a "gender-free" variant but it only uses that one if it doesn't have enough confidence you're a man or a woman. Imagine being a trans woman and the algorithm telling you "we cannot detect that you are a woman so we're ignoring your gender".}
